...
DATABASES = {
    'default': {
        ...
        'NAME': PROJECT_ROOT + 'db/mocks.db',                      # Or path to database file if using sqlite3.
...
# Where to route users that are not logged in
LOGIN_URL = '/login'
...
WSGI_APPLICATION = 'mocks.wsgi.application'
